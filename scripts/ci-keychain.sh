...
#
# Use the team's Developer ID Application certificate, the one for apps given out outside the App Store: with it a
# download notarizes and opens without Gatekeeper's warning. An Apple Development certificate signs as well, but can't
# be notarized.
#
# Repository secrets, shared with FreeAudio and TREM-Lite under the names tauri-action reads (scripts/set-apple-secrets.sh
# sets them):
