...
private struct MenuBarLabel: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("EazyDisplay")
    }
}
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// Opening EazyDisplay again (Finder, Spotlight) shows Settings; that also helps when the menu bar icon is hidden.
