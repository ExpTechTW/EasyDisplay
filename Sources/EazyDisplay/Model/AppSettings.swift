...
final class AppSettings {
    ...
    /// Whether boost was on when EazyDisplay last quit. Only turning it off by hand clears it.
    ...
    /// EazyDisplay takes the brightness keys and changes the display in use, with its own indicator. On unless turned
