...
enum SettingsPage: String, CaseIterable, Identifiable {
    ...
    /// The sidebar's groups: how EasyDisplay behaves, what it has measured, and EasyDisplay itself.
...
final class SettingsWindow {
    ...
    func show(page: SettingsPage? = nil) {
        ...
        // Visible even when macOS doesn't hand EasyDisplay the focus.
    ...
    private func makeWindow(_ models: Models) -> NSWindow {
        ...
        window.setFrameAutosaveName("EasyDisplay.settings")
