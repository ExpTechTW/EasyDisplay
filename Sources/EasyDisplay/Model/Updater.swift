...
/// Checks GitHub for a newer EasyDisplay and replaces this copy with it.
///
...
final class Updater {
    ...
    private var userAgent: String { "EasyDisplay/\(build.label)" }
...
enum UpdateInstaller {
    ...
    private static let api = ProcessInfo.processInfo.environment["EASYDISPLAY_UPDATE_API"] ?? "https://api.github.com"
    #else
