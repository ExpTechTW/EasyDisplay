...
final class MonitorDatabase: Sendable {
    ...
    static var defaultURL: URL {
        ...
        return base
            .appendingPathComponent(Bundle.main.bundleIdentifier ?? "io.github.yuyu1015.EasyDisplay", isDirectory: true)
...
final class SampleWriter: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "EasyDisplay.MonitorDatabase.writer", qos: .utility)
